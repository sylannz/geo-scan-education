const CONFIG = {
  weatherApiUrl:
    "https://api.open-meteo.com/v1/forecast?latitude=-7.67&longitude=109.65&current_weather=true",
...
const TRANSLATIONS = {
  id: {
    ...
    slide0Desc:
      "Bukti nyata pengangkatan dasar laut dari kedalaman 4 km di Watu Kelir.",
    ...
    chatTitle: "Tanya Geo ✨",
    chatWelcome:
      "Halo! Saya Geo, asisten digital UNESCO Global Geopark Kebumen. Ada yang bisa saya bantu?",
  ...
  en: {
    ...
    chatTitle: "Ask Geo ✨",
    chatWelcome:
      "Hello! I am Geo, the digital assistant for UNESCO Global Geopark Kebumen. How can I help you?",
...
function updateUI() {
  ...
  document.getElementById("slide0-btn").innerHTML =
    `${t.slide0Btn} <i data-lucide="arrow-right" class="w-4 h-4 text-red-700"></i>`;
  ...
  document.getElementById("slide1-btn").innerHTML =
    `${t.slide1Btn} <i data-lucide="arrow-right" class="w-4 h-4 text-blue-700"></i>`;
...
function updateCarousel() {
  ...
  dots.forEach((dot, i) => {
    ...
    dot.style.backgroundColor =
      i === STATE.currentSlide ? colors[i] : "#e2e8f0";
  });
}
